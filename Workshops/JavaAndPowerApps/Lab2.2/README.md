# Lab 2.2 - Adding data with the Python ToDo API (Optional).
...
![Screenshot of the "Try it out" button.](/Workshops/JavaAndPowerApps/Lab2.2/assets/get-lists-try-it-out.png)
...
![Screenshot of the response code and the response body](/Workshops/JavaAndPowerApps/Lab2.2/assets/response-code-and-body.png)
...
![Screenshot of the response code and the response body now showing 2 ToDo lists](/Workshops/JavaAndPowerApps/Lab2.2/assets/response-with-new-list.png)
...
![Screenshot of the response code and the response body with the 3 Shopping list items](/Workshops/JavaAndPowerApps/Lab2.2/assets/shopping-list-items.png)

### Next: [Lab 3.2 - Creating a Custom Connector  with Python ToDo API](/Workshops/JavaAndPowerApps/Lab3.2/)
