...
![Screenshot of the Connections section under the Test Tab in the custom connector wizard](/Workshops/PythonAndPowerApps/Lab4/assets/new-custom-connector-connection.png)
...
![GetLists action Test response](/Workshops/PythonAndPowerApps/Lab4/assets/get-lists-response.png)
...
> **Note**: This is the *id* of the *Shopping* list that you created in [Lab 2](https://github.com/microsoft/PowerPlatformAdvocates/tree/main/Workshops/PythonAndPowerApps/Lab2#step-2---add-your-own-list-data).
...
![Body response of updated ToDo list item](/Workshops/PythonAndPowerApps/Lab4/assets/updated-list-item-response.png)
...
![All actions with passed test](/Workshops/PythonAndPowerApps/Lab4/assets/passed-action-tests.png)
...
### Next: [Lab 5 - Creating a Power Apps Canvas App](/Workshops/PythonAndPowerApps/Lab5/)
