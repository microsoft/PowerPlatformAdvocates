...
![Environment picker in Power Apps](/Workshops/DotNetAndPowerApps/Lab3/assets/environment-picker.png)
...
![Screenshot of opened solution](/Workshops/DotNetAndPowerApps/Lab3/assets/open-solution.png)
...
![The custom connector name](/Workshops/DotNetAndPowerApps/Lab3/assets/connector-name.png)
...
4. Copy the URL of the DotNet API and paste it into the *host* field and then remove the ```https://``` protocol. 
 ...
 ![Screenshot of DotNet API Host in Custom Connector wizard](/Workshops/DotNetAndPowerApps/Lab3/assets/host-url-for-connector.png)
...
![New Action button in the custom connector wizard](/Workshops/DotNetAndPowerApps/Lab3/assets/new-action-custom-connector.png)
...
![Import request from sample screenshot](/Workshops/DotNetAndPowerApps/Lab3/assets/import-from-sample-custom-connector.png)

4. Click ```Import```.

The following request should get generated:

![Generated request](/Workshops/DotNetAndPowerApps/Lab3/assets/generated-request.png)
...
![All top query properties](/Workshops/DotNetAndPowerApps/Lab3/assets/top-query-properties.png)
...
![Sample 200 response from API](/Workshops/DotNetAndPowerApps/Lab3/assets/sample-responses.png)
...
![Generated response from sample](/Workshops/DotNetAndPowerApps/Lab3/assets/generated-response.png)
...
![Lists of 3 actions defined so far for ToDo lists](/Workshops/DotNetAndPowerApps/Lab3/assets/list-custom-connectors-actions.png)
...
![Generated response for GetListItems](/Workshops/DotNetAndPowerApps/Lab3/assets/generated-response-listitems.png)
...
![All seven ToDo actions in the customer connector wizard](/Workshops/DotNetAndPowerApps/Lab3/assets/all-seven-actions.png)
...
### Next: [Lab 4 - Testing a Custom Connector](/Workshops/DotNetAndPowerApps/Lab4/)
